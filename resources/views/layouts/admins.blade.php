...
<!-- Mirrored from myrathemes.com/lunoz/layouts/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Oct 2021 02:20:12 GMT -->
<head>
    <meta charset="utf-8" />
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        ...
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user" src="{{ asset('assets/images/users/avatar-2.jpg') }}"
                                alt="Header Avatar">
                            <span class="d-none d-sm-inline-block ml-1">{{ Auth::guard('admins')->user()->name }}</span>
                            <i class="mdi mdi-chevron-down d-none d-sm-inline-block"></i>
                        </button>
        ...
        <div class="vertical-menu">
            ...
            <div data-simplebar class="h-100">
                ...
                <div class="navbar-brand-box">
                    <a href="#" class="logo">
                        <h5 style="color: whitesmoke">RESTAURANT</h5>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        <li class="menu-title">My Restaurant</li>

                        <li>
                            <a href="{{ route('home.admin') }}" class="waves-effect"><i class='bx bx-home-smile'></i><span>Dashboard</span></a>
                        </li>

                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect"><i class="bx bx-home"></i><span>All Pages</span></a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ route('admins') }}">Admins</a></li>
                                <li><a href="{{ route('orders-admins') }}">Orders</a></li> 
                                <li><a href="{{ route('foods-admins') }}">Foods</a></li>
                                <li><a href="{{ route('bookings-admins') }}">Bookings</a></li>
                            </ul>
                        </li>
