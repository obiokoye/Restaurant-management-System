...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-10 py-3 py-lg-0">
                <a href="{{ url('/home') }}" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fa fa-utensils me-3"></i>My Restaurant</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            @else
                                @if (session('cart'))
                                    <a href="{{ route('displaycarts') }}" class="nav-item nav-link">
                                    ...
                                    <div class="col-sm-4 text-center">
                                        ...
                                        @if (session('success'))
                                            <p class="btn-success  mt-3 mb-3 btn-block session"
                            ...
                            @else
                                <a href="{{ route('displaycarts') }}" class="btn text-light bg-warning mt-3 mb-3"
                                    role="button">
                                    <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                                    Cart
                                </a>
