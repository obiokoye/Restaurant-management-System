...
<div class="col-md-12 bg-dark">
    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
        ...
        <form method="POST" action="{{ route('storecheckout') }}"  class="col-md-12">
            @csrf
            <div class="row g-3">
                <div class="col-md-12">
                ...
                <div class="col-12">
                    ...
                    <div class="form-floating">
                        <input type="hidden" name="price" value="{{ $newPrice }}" class="form-control" id="email" placeholder="Phone number">
