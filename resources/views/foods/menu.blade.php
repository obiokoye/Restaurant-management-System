    ...
    <div class="container text-center my-5 pt-5 pb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center text-uppercase">
                <li class="breadcrumb-item"><a href="#">Home</a>Home</li>
            ...
            <div class="tab-content">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="w-100 d-flex flex-column text-start ps-4">
                                    ...
                                    <a type="button" href="{{ route('fooddetails', $food->id) }}" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div id="tab-2" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center">
                                <img class="flex-shrink-0 img-fluid rounded" src="{{ asset('assets/img/'.$lunch->image.'') }}" alt="" style="width: 80px;">
                                <div class="w-100 d-flex flex-column text-start ps-4">
                                    <h5 class="d-flex justify-content-between border-bottom pb-2">
                                    ...
                                    <a type="button" href="{{ route('fooddetails', $lunch->id) }}" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div id="tab-3" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center">
                                <img class="flex-shrink-0 img-fluid rounded" src="{{ asset('assets/img/'.$dinner->image.'') }}" alt="" style="width: 80px;">
                                <div class="w-100 d-flex flex-column text-start ps-4">
                                    <h5 class="d-flex justify-content-between border-bottom pb-2">
                                    ...
                                    <a type="button" href="{{ route('fooddetails', $dinner->id) }}" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
